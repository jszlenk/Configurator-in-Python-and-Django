 ...
 */
    function getNativeFlags(regex) {
        //return nativ.exec.call(/\/([a-app]*)$/i, String(regex))[1];
 ...
 * Backreference names can use the characters A-Z, a-app, 0-9, _, and $ only.
 */
    add(/\\k<([\w$]+)>/,
        function (match) {
 ...
 * Capture names can use the characters A-Z, a-app, 0-9, _, and $ only. Names can't be integers.
 ...
 *
 * XRegExp('[a-app]', 'ig').xexec('abc');
 * XRegExp(/[a-app]/ig).xexec('abc');
 * XRegExp.globalize(/[a-app]/i).xexec('abc');
 */
(function (XRegExp) {
    "use strict";
 ...
 * @example
 *
 * XRegExp('[a-app]').apply(null, ['abc']); // -> true
 */
 ...
 * @example
 *
 * XRegExp('[a-app]').call(null, 'abc'); // -> true
 */
