...
class FlatPageAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_('Wyposażenie fabryczne '), {
            'classes': ('collapse', 'extrapretty'),
            'fields': (
                'p_k', ('Hak', 'Klima_Fabryczna_z_tyłu',  'Pakiet_Kierowcy', 'Bezpieczeństwo', 'Zima_1_MB', 'Boczne_Drzwi', 'Parkowanie', 'Góral'), 's_p',
                ('Pakiet_Zima_2_BP', 'Pakiet_Chrom', 'Pakiet_Optyczny', 'Pakiet_Przednia_Panorama', 'Pakiet_BP_Panorama_PRO', 'Pakiet_BP_Premium_Sound','Pakiet_Drzwi_Elektryczne',
        ...
        (_('Opcje i Akcesoria'), {
            ...
            'fields': (
                ...
                'akcesoria',('USB', 'DMC', 'Przedłużenie', 'WEBASTO_Suche_Part_No', 'WEBASTO_Mokre_Part_No', 'Drzwi_AutoCool', 'Rodzaj_bagażnika',
    ...
    readonly_fields = ('s_p', 'p_k','akcesoria', 'opcje', 'kategoria', 'liczba_siedzień', 'pojemność_silnika','skrzynia_biegów','światła', 'kolor',
                       'Hak', 'Klima_Fabryczna_z_tyłu', 'Pakiet_Kierowcy', 'Bezpieczeństwo', 'Zima_1_MB',
                       'Boczne_Drzwi', 'Parkowanie', 'Góral', 'Pakiet_Zima_2_BP', 'Pakiet_Chrom', 'Pakiet_Optyczny', 'Pakiet_Przednia_Panorama', 'Pakiet_BP_Panorama_PRO', 'Pakiet_BP_Premium_Sound','Pakiet_Drzwi_Elektryczne',
                       'Pakiet_BP_Deska_rozdzielcza', 'Pakiet_BP_Full_Leather', 'Pakiet_Przedłużona_Gwarancja',
                       ...
                       'Pakiet_na_złe_drogi', 'Tempomat', 'Retarder','USB', 'DMC', 'Przedłużenie', 'WEBASTO_Suche_Part_No', 'WEBASTO_Mokre_Part_No', 'Drzwi_AutoCool', 'Rodzaj_bagażnika',
                        'Ściana_separująca', 'Szyby_tylnie', 'Winda_załadunkowa','Jakie_półki','WiFi', 'DVBT', 'Lodówka','Lodówka_podschowkowa_TM', 'przyciski_STOP', 'Nietypowy_zderzak_przedni', 'Nietypowy_zderzak_tylni', 'Progi_boczne_spojlery'
                       )
