    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefon', models.CharField(max_length=15, validators=[django.core.validators.RegexValidator(message="Numer telefonu należy wprowadzić w formacie: '+500500500'. Dopuszczalne do 15 cyfr", regex='^\\+?1?\\d{9,15}$')])),
                ('ulica', models.CharField(blank=True, max_length=250)),
                ...
                ('wiadomość', models.TextField(blank=True, max_length=400, null=True)),
                ('NIP', models.CharField(max_length=18, validators=[django.core.validators.RegexValidator(message='Tylko cyfry. Dopuszczalne do 18 cyfr', regex='^[0-9]{7,18}')])),
                ('wyceniono', models.BooleanField(default=False)),
                ('kategoria', models.CharField(choices=[('Basic', 'Basic'), ('Tourist', 'Tourist'), ('Exclusive', 'Exclusive')], default='', max_length=350)),
                ('liczba_siedzień', models.CharField(choices=[('Standard 16+1', 'Standard 16+1'), ('Przedłużka 16+1', 'Przedłużka 16+1'), ('Przedłużka 19+1', 'Przedłużka 19+1')], default='', max_length=350)),
                ('pojemność_silnika', models.CharField(choices=[('4 Cylindrów', '4 Cylindrów'), ('6 Cylindrów', '6 Cylindrów')], default='', max_length=350)),
                ('skrzynia_biegów', models.CharField(choices=[('Manulana', 'Manulana'), ('Automatyczna', 'Automatyczna')], default='', max_length=350)),
                ('światła', models.CharField(choices=[('Halogeny', 'Halogeny'), ('Ksenony', 'Ksenony')], default='', max_length=350)),
                ('kolor', models.CharField(choices=[('E1E3E4', 'E1E3E4'), ('354B6C', '354B6C'), ('6C4444', '6C4444'), ('0090FF', '0090FF'), ('ACA79C', 'ACA79C'), ('798790', '798790'), ('2E6668', '2E6668'), ('2F2F2F', '2F2F2F'), ('D4D0C6', 'D4D0C6'), ('9C9B93', '9C9B93'), ('595B57', '595B57'), ('EAC455', 'EAC455'), ('307098', '307098'), ('D32130', 'D32130'), ('D12235', 'D12235'), ('868D8F', '868D8F'), ('2A436C', '2A436C'), ('323437', '323437'), ('534642', '534642'), ('B7BCBF', 'B7BCBF'), ('464F55', '464F55'), ('525350', '525350'), ('999791', '999791'), ('4A4F68', '4A4F68')], default='E1E3E4', max_length=350)),
